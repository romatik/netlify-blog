...
Apparently, both of those phenomenon's can be explained with what is called ["Hitchiker's paradox"](https://the8layers.com/2016/10/30/how-long-will-you-wait-hitchhiking-on-the-road/). To save you a bit of clicking, the upshot is that:
...
I've learned about long time ago and as soon as I did I started noticing it everywhere. Not that those things didn't happen with me before, so it is probably some variant of [Baader-Meinhof phenomenon](https://en.wikipedia.org/wiki/List_of_cognitive_biases#Frequency_illusion).
